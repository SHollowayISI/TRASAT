...
scenario.multi.n_fr = 300;
scenario.multi.n_re = 2;
...
scenario.multi.radar_pos = ...
    [0, 0; 1*nm, 1*nm; -6000, -6000];

% Normal direction of radar units
scenario.multi.radar_dir = [0 0; 0 0];
...
scenario.rcs = struct( ...
    ...
    ... % RCS options
    'rcs_model',    'static', ...        % Set 'model' or 'constant'
...
scenario.traj = struct( ...
    ...
    ...
    ... % Model options
    'model',    'linear', ...               % Set 'static' or 'model'
