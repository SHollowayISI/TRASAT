...
scenario.multi.n_fr = 30;
scenario.multi.n_re = 1;
...
scenario.multi.radar_dir = [180; 0];
...
% Tracking Parameters
scenario.multi.sigma_v = 2;                    % Process variance for Kalman Filter
scenario.multi.sigma_z = 1.95;                     % Measurement variance for Kalman Filter
...
scenario.traj = struct( ...
    ...
    ...
    'pos_st',   [2563; 2048; 500], ...          % Position input if 'static' is used
    'vel_st',   [156; 200; 0], ...          % Velocity input if 'static' is used
    ...
    ... % Model options
