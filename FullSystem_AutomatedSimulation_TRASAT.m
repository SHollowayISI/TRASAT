%% TRASAT Radar System - Automated Testing
%{
    ...
    Automated Testing System - Takes radar scenarios from 'Automated
    Testing/To Run' and performs simulation for each. Optionally also sends
    email to designated email with figure files upon completion.

    TODO: Main Loop: Move method options to simsetup
    TODO: Tracking: Ensure correct multilateration
